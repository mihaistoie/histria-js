...
class Transaction {
    ...
    find(classOfInstance, filter) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (store) {
                let list = yield store.find(classOfInstance.name, filter, { compositions: false });
                if (list && list.length) {
    ...
    findOne(classOfInstance, filter, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let store = that._store(classOfInstance);
            if (store) {
                let list = yield store.findOne(classOfInstance.name, filter, { compositions: true });
                if (list && list.length) {
                    return yield that.load(classOfInstance, list[0]);
                }
            }
            return null;
        });

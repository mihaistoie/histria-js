        ...
        Object.keys(schema.properties || {}).forEach(propName => {
            ...
            switch (stype) {
                case schema_consts_1.JSONTYPES.string:
                    ...
                    code.push(_tab(1) + util.format('public %s(): string {', propName));
        ...
        schema.relations && Object.keys(schema.relations).forEach(relName => {
            ...
            switch (relation.type) {
                ...
                case schema_consts_1.RELATION_TYPE.hasMany:
                    let cn = (relation.aggregationKind === schema_consts_1.AGGREGATION_KIND.shared) ? 'HasManyAggregation' : 'HasManyComposition';

...
function saveCode(codeByClass, codeByNamespace, dstFolder) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(writersClasses.concat(writersNamespaces));
    });
}
...
function classGenerator(srcFolder, dstFolder, pathToLib) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield saveCode(codeByClass, codeByNamespace, dstFolder);
    });
}

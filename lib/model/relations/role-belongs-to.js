...
class BaseBelongsTo extends role_1.Role {
    _lazyLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            let query = histria_utils_2.schemaUtils.roleToQueryInv(that._relation, that._parent.model());
            if (query) {
                let opts = { onlyInCache: false };
                return yield that._parent.transaction.findOne(that._refClass, query, opts);
            }
            return null;
        });
    }
    ...
    _getValue() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (res === undefined) {
                ...
                let p = that._parent;
                // parent of p is res
                yield p.changeParent(res, that._relation.invRel, that._propertyName || histria_utils_1.DEFAULT_PARENT_NAME, false);
            }
            return res;
        });
    }
    ...
    _setValue(value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!changeParentCalled) {
                ...
                yield p.changeParent(newParent, that._relation.invRel, that._propertyName || histria_utils_1.DEFAULT_PARENT_NAME, true);
            }
            let res = that._parent.parent;
            return res;
        });

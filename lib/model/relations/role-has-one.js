            ...
            if (that._relation.invRel) {
                ...
                if (that._value) {
                    ...
                    if (useInv)
                        ...
                        histria_utils_1.schemaUtils.updateRoleRefs(that._relation, fmodel, lmodel, true);
                }
            }
        }, { isLazyLoading: false });
        ...
        if (childModel === null)
            ...
            if (!isRestore) {
                ...
                if (useInv)
                    ...
                    histria_utils_1.schemaUtils.updateRoleRefs(that._relation, pmodel, childModel, true);
            }
        }
    }

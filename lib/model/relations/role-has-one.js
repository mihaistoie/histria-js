    ...
    _lazyLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                ...
                that._value = (yield that._parent.transaction.findOne(that._refClass, query, opts)) || null;
            }
            else
                that._value = null;
        });
    ...
    _lazyLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (query) {
                that._value = null;
                let opts = { onlyInCache: false };
                that._value = yield that._parent.transaction.findOne(that._refClass, query, opts);
...
class HasOneComposition extends HasOneAC {
    ...
    _afterSetValue(newValue, oldValue) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            if (newValue) {
                yield newValue.changeParent(that._parent, that._propertyName, that._relation.invRel || histria_utils_1.DEFAULT_PARENT_NAME, true);
                that._parent.model()[that._propertyName] = newValue.model();
            }
            if (oldValue) {
                yield oldValue.changeParent(null, that._propertyName, that._relation.invRel || histria_utils_1.DEFAULT_PARENT_NAME, true);
            }
            if (!newValue) {
    ...
    _updateInvSideAfterLazyLoading(newValue) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            if (newValue)
                yield newValue.changeParent(that._parent, that._propertyName, that._relation.invRel || histria_utils_1.DEFAULT_PARENT_NAME, false);
        });
    }
    destroy() {
        let that = this;

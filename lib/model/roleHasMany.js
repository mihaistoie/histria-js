    ...
    remove(element) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item) {
                ...
                yield item.changeParent(null, that._propertyName, that._relation.invRel || schema_consts_1.DEFAULT_PARENT_NAME, true);
            }
    ...
    add(item, index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item) {
                ...
                yield item.changeParent(that._parent, that._propertyName, that._relation.invRel || schema_consts_1.DEFAULT_PARENT_NAME, true);
            }
            return item;
        });
    }
                ...
                if (valueIsNull) {
                    ...
                    if (items.length) {
                        ...
                        for (let index = 0; index < items.length; index++) {
                            ...
                            yield item.changeParent(that._parent, that._propertyName, that._relation.invRel || schema_consts_1.DEFAULT_PARENT_NAME, false);
                        }
                    }
                    else
                        that._model = null;
    ...
    add(item, index) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (item) {
                ...
                schema_utils_1.updateRoleRefs(that._relation, lmodel, rmodel, true);
                yield item.changeParent(that._parent, that._propertyName, that._relation.invRel, true);
            }
            return item;
        });
    }

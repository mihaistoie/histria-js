    ...
    _lazyLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (valueIsNull)
                ...
                yield that._updateInvSide(that._value);
            }
        });
    }
...
class HasOneAggregation extends HasOneAC {
    ...
    _afterSetValue(newValue, oldValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (oldValue) {
                let r = oldValue.getRoleByName(that._relation.invRole);
                if (r)
                    r.internalSetValue(null);
            }
            if (newValue) {
                let r = newValue.getRoleByName(that._relation.invRole);
                if (r)
                    r.internalSetValue(that._parent);
            }
        });
    }
    _updateInvSide(newValue) {

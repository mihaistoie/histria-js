    ...
    _lazyLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (valueIsNull)
                ...
                that._value = (yield that._parent.transaction.findOne(that._refClass, query)) || null;
        });
    }
    _setValue(value) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    _lazyLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (valueIsNull)
                ...
                that._value = yield that._parent.transaction.findOne(that._refClass, query);
...
class HasOneComposition extends HasOneAC {
    constructor(parent, propertyName, relation) {
        ...
        if (childModel === null)
            ...
            if (!isRestore)
                schema_utils_1.updateRoleRefs(that._relation, childModel, pmodel, true);
        }
    }
    _afterSetValue(newValue, oldValue) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            if (newValue)
                yield newValue.changeParent(that._parent, that._propertyName, that._relation.invRel || schema_consts_1.DEFAULT_PARENT_NAME, true);
            if (oldValue)
                yield oldValue.changeParent(null, that._propertyName, that._relation.invRel || schema_consts_1.DEFAULT_PARENT_NAME, true);
        });
    }
    _updateInvSideAfterLazyLoading(newValue) {
        return __awaiter(this, void 0, void 0, function* () {
            let that = this;
            if (newValue) {
                yield newValue.changeParent(that._parent, that._propertyName, that._relation.invRel || schema_consts_1.DEFAULT_PARENT_NAME, false);
            }
        });
    }
}
    ...
    _afterSetValue(newValue, oldValue) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (newValue) {
                ...
                if (r)
                    yield r.internalSetValueAndNotify(that._parent, newValue);
            }
        });
    }
    _updateInvSideAfterLazyLoading(newValue) {

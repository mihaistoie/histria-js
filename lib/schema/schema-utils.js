...
function typeOfProperty(propSchema) {
    ...
    if (isComplex(propSchema) && propSchema.reference) {
        if (isArray(propSchema))
            return schema_consts_1.JSONTYPES.refarray;
        else
            return schema_consts_1.JSONTYPES.refobject;
    }
    return ps;
}
...
function isArray(schema) {
    return (schema.type === schema_consts_1.JSONTYPES.array);
}
exports.isArray = isArray;
function isComposition(schema) {

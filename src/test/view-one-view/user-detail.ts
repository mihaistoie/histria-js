...
export class UserDetail extends View {
    ...
    public get streetId(): any {
        return this._children.streetId.value;
    }
    ...
    public street(): Promise<AdressView> {
        return this._children.street.getValue();
    }
    public setStreet(value: AdressView): Promise<AdressView> {
        return this._children.street.setValue(value);
    }
...
export class UserDetailErrors extends InstanceErrors {
    ...
    public get streetId(): ErrorState {
        return this._messages.streetId;
    }
}
...
export class UserDetailState extends InstanceState {
    ...
    public get streetId(): IdState {
        return this._states.streetId;
    }
}
export const
    USERDETAIL_SCHEMA = {

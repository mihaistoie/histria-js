...
async function testCreate() {
    ...
    const cd = await transaction.create(aggregations_model_1.Cd);
    const song1 = await transaction.create(aggregations_model_1.Song);
    const song2 = await transaction.create(aggregations_model_1.Song);
...
async function testLoad() {
    const transaction = new index_1.Transaction();
    const cd = await transaction.create(aggregations_model_1.Cd);
    const song1 = await transaction.load(aggregations_model_1.Song, { cdId: cd.uuid });
    const song2 = await transaction.load(aggregations_model_1.Song, { cdId: cd.uuid });
...
async function testRemove() {
    ...
    const song = await transaction.findOne(aggregations_model_1.Song, { id: uuid });

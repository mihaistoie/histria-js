...
async function testCreate() {
    ...
    const child01 = await transaction.create(cyclicreferencesviews_model_1.Item);
    const child02 = await transaction.create(cyclicreferencesviews_model_1.Item);
    const rootGroup = await transaction.create(cyclicreferencesviews_model_1.Group);
    const group = await transaction.create(cyclicreferencesviews_model_1.Group);
    const item02 = await transaction.create(cyclicreferencesviews_model_1.Item);
    ...
    const root = await transaction.findOne(cyclicreferencesviews_model_1.Group, { id: rootId });
